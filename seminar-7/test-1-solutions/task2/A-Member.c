...
void find_and_print_subsequences(int *required_signs, int num_collegues, int num_signs_required,
...
void find_and_print_subsequences(int *required_signs, int num_collegues, int num_signs_required,
    ...
    for (int coleg_idx = 0; coleg_idx < num_collegues; ++coleg_idx) {
        ...
        find_and_print_subsequences(required_signs, num_collegues, num_signs_required,
                                    current_num_signs + 1);
